...
class ControllerExtensionThemeMytheme extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['theme_mytheme_directory'])) {
			...
			$data['theme_mytheme_directory'] = 'mytheme';
		}		
		...
		if (isset($this->request->post['theme_mytheme_status'])) {
			...
			$data['theme_mytheme_status'] = $setting_info['theme_mytheme_status'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_product_description_length'])) {
			...
			$data['theme_mytheme_product_description_length'] = $setting_info['theme_mytheme_product_description_length'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_category_width'])) {
			...
			$data['theme_mytheme_image_category_width'] = $setting_info['theme_mytheme_image_category_width'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_category_height'])) {
			...
			$data['theme_mytheme_image_category_height'] = $setting_info['theme_mytheme_image_category_height'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_thumb_width'])) {
			...
			$data['theme_mytheme_image_thumb_width'] = $setting_info['theme_mytheme_image_thumb_width'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_thumb_height'])) {
			...
			$data['theme_mytheme_image_thumb_height'] = $setting_info['theme_mytheme_image_thumb_height'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_popup_width'])) {
			...
			$data['theme_mytheme_image_popup_width'] = $setting_info['theme_mytheme_image_popup_width'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_popup_height'])) {
			...
			$data['theme_mytheme_image_popup_height'] = $setting_info['theme_mytheme_image_popup_height'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_product_width'])) {
			...
			$data['theme_mytheme_image_product_width'] = $setting_info['theme_mytheme_image_product_width'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_product_height'])) {
			...
			$data['theme_mytheme_image_product_height'] = $setting_info['theme_mytheme_image_product_height'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_additional_width'])) {
			...
			$data['theme_mytheme_image_additional_width'] = $setting_info['theme_mytheme_image_additional_width'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_additional_height'])) {
			...
			$data['theme_mytheme_image_additional_height'] = $setting_info['theme_mytheme_image_additional_height'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_related_width'])) {
			...
			$data['theme_mytheme_image_related_width'] = $setting_info['theme_mytheme_image_related_width'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_related_height'])) {
			...
			$data['theme_mytheme_image_related_height'] = $setting_info['theme_mytheme_image_related_height'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_compare_width'])) {
			...
			$data['theme_mytheme_image_compare_width'] = $setting_info['theme_mytheme_image_compare_width'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_compare_height'])) {
			...
			$data['theme_mytheme_image_compare_height'] = $setting_info['theme_mytheme_image_compare_height'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_wishlist_width'])) {
			...
			$data['theme_mytheme_image_wishlist_width'] = $setting_info['theme_mytheme_image_wishlist_width'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_wishlist_height'])) {
			...
			$data['theme_mytheme_image_wishlist_height'] = $setting_info['theme_mytheme_image_wishlist_height'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_cart_width'])) {
			...
			$data['theme_mytheme_image_cart_width'] = $setting_info['theme_mytheme_image_cart_width'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_cart_height'])) {
			...
			$data['theme_mytheme_image_cart_height'] = $setting_info['theme_mytheme_image_cart_height'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_location_width'])) {
			...
			$data['theme_mytheme_image_location_width'] = $setting_info['theme_mytheme_image_location_width'];
		} else {
		...
		if (isset($this->request->post['theme_mytheme_image_location_height'])) {
			...
			$data['theme_mytheme_image_location_height'] = $setting_info['theme_mytheme_image_location_height'];
		} else {
